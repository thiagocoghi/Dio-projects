...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /* //precisamos organizar os valores. Logo:
        ...
        Set<Map.Entry<Integer, Contato>> set1 = new TreeSet<>(Comparator.comparing(nomeOrdem -> nomeOrdem.getValue().getNome()));
        set1.addAll(agenda.entrySet());
        for(Map.Entry<Integer, Contato> entry1: set1){
            System.out.println(entry1.getKey() + " - " + entry1.getValue().getNumero() +
